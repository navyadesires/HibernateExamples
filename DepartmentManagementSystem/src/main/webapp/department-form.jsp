            ...
            <body>
                ...
                <div align="center">
                    ...
                    <table border="1" cellpadding="5">
                        ...
                        <c:if test="${existingDepartment!=null}">
                            <input type="hidden" name="eid" value="<c:out value='${existingDepartment.depId}' />" />
                        </c:if>
                        <tr>
                            <th> Department Name: </th>
                            <td><input type="text" name="ename"
                                    value="<c:out value='${existingDepartment.depName}' />" />
                            </td>
                        </tr>
                        <tr>
                            <th> Department Email: </th>
                            <td><input type="text" name="eemail"
                                    value="<c:out value='${existingDepartment.depEmail}' />" />
                            </td>
                        </tr>
                        <tr>
                            <th> Department MobileNo: </th>
                            <td><input type="text" name="dmobno"
                                    value="<c:out value='${existingDepartment.depMobileNo}' />" />
                            </td>
                        </tr>
                        <tr>
